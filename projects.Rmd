...
### AlphaFold 3
### AlphaFold Multimer: Whats different from AlphaFold multimer
### AlphaFold 2
...
<hr style="border:2px solid gray"> </hr>
```{r, echo=FALSE, out.width="500%",out.height="500%",fig.cap=" Comparison of SGD with Momentum or Nesterov Accelerated Gradient, and Adam methods and their rate of convergence. (b) Image compression using PCA",fig.show='hold',fig.align='left'}

...
### **<span style="text-decoration: underline">Face Generation with GANs</span>** **[<span style="color:magenta">[GitHub]</span>](https://github.com/punitjha/Generative-Adversarial-Network)**
...
### **<span style="text-decoration: underline">Text Generation & Language classification (RNNs)** **[<span style="color:magenta">[GitHub]</span>](https://github.com/punitjha/Recurrent-Neural-Networks)**
...
### **<span style="text-decoration: underline">Multi Label Image Classification** **[<span style="color:magenta">[GitHub]</span>](https://github.com/punitjha/Multi-Label-Image-Classification)**
...
```
  ...
  - I implement a multi-label image classifier on the [<span style="color:magenta">PASCAL VOC 2007 </span>](http://host.robots.ox.ac.uk/pascal/VOC/voc2007) dataset. I basically run three experiments
    - Train AlexNet (PyTorch built-in) from scratch.
    - Fine-tune AlexNet (PyTorch built-in), which is pretrained on [<span style="color:magenta">ImageNet.</span>](http://www.image-net.org/)
...
### **<span style="text-decoration: underline">Multi Layer Neural Networks** **[<span style="color:magenta">[GitHub]</span>](https://github.com/punitjha/Multi-Layer-Neural-Networks)**
...
```
  ...
  - I implemented multi-layer neural networks from scratch on the [<span style="color:magenta"> CIFAR-10 </span>](https://www.cs.toronto.edu/~kriz/cifar.html) image classification dataset, to understand the fundamentals of neural networks and backpropagation.
...
***
### **<span style="text-decoration: underline">Ad Hoc Information Retrieval System** **[<span style="color:magenta">[GitHub]</span>](https://github.com/punitjha/ECE365-Data_Science_and_Engineering/tree/master/NLP_Lab5)**
...
```
  ...
  - The model was trained on the  [<span style="color:magenta"> Cranfield collection </span>](http://ir.dcs.gla.ac.uk/resources/test_collections/cran/).  This was the pioneering test collection in allowing precise quantitative measures of information retrieval effectiveness, but is nowadays too small for anything but the most elementary pilot experiments. Collected in the United Kingdom starting in the late 1950s, it contains 1398 abstracts of aerodynamics journal articles, a set of 225 queries, and exhaustive relevance judgments of all (query, document) pairs.
...
***
###  **<span style="text-decoration: underline">Machine Learning Algorithms Using only Numpy**
...
- I implemented a few ML algorithms from scratch using only Python Numpy. All of these algorithms are run on tiny datasets on a standard CPU laptop. These were part of assigments from CS-446 and CS-498.
  - Stochastic Gradient Descent Variants - SGD with Momentum or Nesterov Accelerated Gradient, and Adam. [<span style="color:magenta">[GitHub]</span>](https://github.com/punitjha/ML-from-Scratch)
  - GMM [<span style="color:magenta">[GitHub]</span>](https://github.com/punitjha/ML-from-Scratch)
  - HMM [<span style="color:magenta">[GitHub]</span>](https://github.com/punitjha/ML-from-Scratch)
  - PCA [<span style="color:magenta">[GitHub]</span>](https://github.com/punitjha/ML-from-Scratch)
  - RNN [<span style="color:magenta">[GitHub]</span>](https://github.com/punitjha/ML-from-Scratch)
  - Adaboost On Stumps [<span style="color:magenta">[GitHub]</span>](https://github.com/punitjha/ML-from-Scratch)
  - Feed Forward Neural Network [<span style="color:magenta">[GitHub]</span>](https://github.com/punitjha/ML-from-Scratch)
  - kNN, LDA and Bayse Classifiers and comparision with corresponding scikit-learn modules. [<span style="color:magenta"> [GitHub] </span>](https://github.com/punitjha/ECE365-Data_Science_and_Engineering/blob/master/Lab2_vvv/punit2_lab2.ipynb)
  - Mulit-layer Neural Networks (2 and 3 layered NN with SGD and Adam) [<span style="color:magenta"> [GitHub] </span>](https://github.com/punitjha/Multi-Layer-Neural-Networks)
  - Logistic regression   [<span style="color:magenta"> [GitHub] </span>](https://github.com/punitjha/Linear-Classifiers)
  - Perceptron   [<span style="color:magenta"> [GitHub] </span>](https://github.com/punitjha/Linear-Classifiers)
  - SVM   [<span style="color:magenta"> [GitHub] </span>](https://github.com/punitjha/Linear-Classifiers)
  - Softmax  [<span style="color:magenta"> [GitHub] </span>](https://github.com/punitjha/Linear-Classifiers)
 

***
###  **<span style="text-decoration: underline"> Machine Learning, NLP, and Text Analysis using Scikit-learn **

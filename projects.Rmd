...
```{r, echo=FALSE, out.width=" 45%",out.height="45%",fig.cap=" Deep Convolutional Generative Adversarial Networks. Ref: https://gluon.mxnet.io/chapter14_generative-adversarial-networks/dcgan.html",fig.show='hold',fig.align='left'}
